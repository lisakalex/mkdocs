...
Crawley, UK · 07531 953527 · alexlisak@hotmail.com  
...
automating infrastructure, optimising CI/CD pipelines, and delivering reliable hybrid-cloud solutions.  
Proficient in Jenkins, Ansible and Docker with hands-on experience implementing Infrastructure
...
- CI/CD & Automation: Jenkins, Groovy Pipelines, Git, Ansible
- Infrastructure as Code (IaC): Ansible, Declarative configuration management
- Programming & Scripting: Python, Groovy, Java, PHP
- Version Control & Build Tools: Git, Maven, Swagger
...
- Monitored pipeline performance and system health (tools like Jenkins logs, basic alerting, Grafana and Prometheus),
...
- Owned enterprise release calendars and coordinated multi-team cutovers across DevOps, DBA, and Infrastructure.
- Standardised release governance processes, improving visibility and compliance across environments.
- Enhanced accuracy of release notes and streamlined approval workflows for production deployments.
...
Esure Group plc · Reigate, UK  
*Aug 2017 – Jun 2019*

- Developed RESTful microservices using Spring Boot and Java 8, integrated via Travis CI and deployed on
  AWS.
- Researched and prototyped migration paths to microservice architecture, improving scalability and fault isolation.
...
- As a Software Engineer I play a vital role in the company's Business Systems team, where the focus is on the backbone
  of the organization: its internal software infrastructure.
...
*The Open University* · 2011 – 2015 · 2:2
